...
from Teamjb.utils.human_readable import humanbytes
from Teamjb.utils.file_properties import get_file_ids
from Teamjb.server.exceptions import InvalidHash
import urllib.parse
import logging
import aiohttp
...
async def render_page(id, secure_hash, src=None):
    ...
    if tag in ["video", "audio"]:
        template_file = "Teamjb/template/req.html"
    else:
        template_file = "Teamjb/template/dl.html"
